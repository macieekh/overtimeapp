...
class OvertimesControllerTest < ActionController::TestCase
  ...
  test "should create overtime" do
    assert_difference('Overtime.count') do
      post :create, overtime: { description: @overtime.description, end_time: @overtime.end_time, start_time: @overtime.start_time }
    end
  ...
  test "should update overtime" do
    patch :update, id: @overtime, overtime: { description: @overtime.description, end_time: @overtime.end_time, start_time: @overtime.start_time }
    assert_redirected_to overtime_path(assigns(:overtime))
  end
